...
############################################################################################################################################
############################################## Model 1A(without User Payment Preference)####################################################
# HistGradientBoost
############################################################################################################################################
...
estimator = xgb.XGBClassifier(gamma =1, learning_rate= 0.5, max_depth= 5, reg_lambda= 70, eval_metric='mlogloss',use_label_encoder =False)
